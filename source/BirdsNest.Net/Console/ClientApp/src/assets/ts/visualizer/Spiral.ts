...
export default class Spiral {
    ...
    x = 0;
    y = 0;
    private maincounter = -1;
    private directionalcounter = -1;
    private inverter = -1; //this is either 1 or -1 to reverse direction
    private xy = false; //working on x or y. x is true
