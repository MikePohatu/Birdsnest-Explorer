...
(function (AdvancedSearch) {
    class AdvancedSearchCoordinator {
        constructor(pathelementid, conditionelementid) {
            ...
            this.AddConditionRoot = function () {
                ...
                this.ConditionRoot = new AdvancedSearch.ViewTreeNode(andcond, "Conditions");
    ...
    AdvancedSearch.SearchNode = SearchNode;
    class SearchEdge {
        constructor() {
            this.Name = "";
            this.Label = "";
    ...
    AdvancedSearch.SearchEdge = SearchEdge;
    ...
    AdvancedSearch.AndOrCondition = AndOrCondition;
    class ConditionBase {
        constructor() {
            this.Type = "";
            this.Name = "";
    ...
    AdvancedSearch.ConditionBase = ConditionBase;
    ...
    AdvancedSearch.MathCondition = MathCondition;
    ...
    AdvancedSearch.StringCondition = StringCondition;
