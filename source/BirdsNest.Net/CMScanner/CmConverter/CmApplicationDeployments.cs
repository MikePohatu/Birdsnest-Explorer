...
{
    public class CmApplicationDeployments : ICmCollector
    {
        public string ProgressMessage { get { return "Creating application deployments: "; } }
        public string Query
        {
            get
            {
                return "UNWIND $Properties AS dep " +
                "MATCH (n:" + Types.CMApplication + " {id:dep.CIID}) " +
        ...
        public NeoQueryData CollectData()
        {
            ...
            try
            {
                ...
                string cmquery = "select * from SMS_DeploymentSummary WHERE FeatureType=" + (int)SccmItemType.Application;
