...
{
    public class FacadeGroupDrivesCollectionPage : IDrivesCollectionPage
    {
        private IGroupDrivesCollectionPage _page;
        ...
        public IDrivesRequest NextPageRequest
        {
            get
            {
                return FacadeGroupDrivesRequest.GetFacade(this._page.NextPageRequest);
            }
        }
