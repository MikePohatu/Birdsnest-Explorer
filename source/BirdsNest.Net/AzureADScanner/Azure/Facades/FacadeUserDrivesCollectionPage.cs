...
{
    public class FacadeUserDrivesCollectionPage : IDrivesCollectionPage
    {
        private IUserDrivesCollectionPage _page;
        ...
        public IDrivesRequest NextPageRequest
        {
            get
            {
                return FacadeUserDrivesRequest.GetFacade(this._page.NextPageRequest);
            }
        }
